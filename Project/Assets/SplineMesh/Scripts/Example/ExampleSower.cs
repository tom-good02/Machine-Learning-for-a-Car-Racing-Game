...
namespace SplineMesh {
    ...
    public class ExampleSower : MonoBehaviour {
        ...
        public float xScale = 1, yScale = 1, zScale = 1, scaleRange = 0;
        ...
        public void Sow() {
            ...
            while (distance <= spline.Length) {
                ...
                // apply scale + random
                float xRangedScale = xScale + UnityEngine.Random.Range(0, scaleRange);
                float yRangedScale = yScale + UnityEngine.Random.Range(0, scaleRange);
                float zRangedScale = zScale + UnityEngine.Random.Range(0, scaleRange);
                go.transform.localScale = new Vector3(xRangedScale, yRangedScale, zRangedScale);
